...
<body>
	<div id="top">
		...
		<div style="margin-left: 1150px;">
			<p style="color:blue;">
				欢迎：<a href="javascript:0;">${sessionScope.student.sname}</a>同学 | <a
			...
			<div id="con">
				<ul id="list" class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> 实验室一览 <b class="caret"></b>
					</a>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> 学生选课 <b class="caret"></b>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> 租借 <b class="caret"></b>
					</a>
						<ul class="dropdown-menu">
							<li><a href="#">实验室</a></li>
							<li><a href="#">实验器材</a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> 信息查询 <b class="caret"></b>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> 规章制度 <b class="caret"></b>
					</a>
						<ul class="dropdown-menu">
...
$(function(){
	var thislink = "/notice/getNewNotice";
