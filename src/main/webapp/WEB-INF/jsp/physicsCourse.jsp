...
<table id="courselist" class="easyui-datagrid" title="物理实验课程"
		pagination="true" toolbar="#toolbar"
		data-options="singleSelect:false,collapsible:true,pagination:true,url:'/course/physics',method:'get',pageSize:10">
		<thead>
			<tr>
