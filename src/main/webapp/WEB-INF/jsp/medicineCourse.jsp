...
<table id="courselist" class="easyui-datagrid" title="多媒体课程"
		pagination="true" toolbar="#toolbar"
		data-options="singleSelect:false,collapsible:true,pagination:true,url:'/course/medicine',method:'get',pageSize:10">
		<thead>
			<tr>
	...
	function destroyCourse(){  
            ...
            if (row){  
                $.messager.confirm('Confirm','确定要删除这个课程？',function(r){  
                    if (r){  
                        $.post('/course/del',{labNum:row.labNum},function(result){  
